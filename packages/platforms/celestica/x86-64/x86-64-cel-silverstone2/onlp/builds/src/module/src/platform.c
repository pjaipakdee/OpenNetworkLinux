...
int get_sensor_info(int id, int *temp, int *warn, int *error, int *shutdown)
{
    ...
    char *token = NULL;
    char *Thermal_sensor_name[14] = {
        "TEMP_CPU", "TEMP_BB_U3","TEMP_SW_Internal", "TEMP_SW_U16", "TEMP_SW_U52",
        "TEMP_FAN_U17", "TEMP_FAN_U52","SW_U71_Temp1","SW_U71_Temp2","SW_U78_Temp1",
