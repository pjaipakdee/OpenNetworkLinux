...
static struct platform_driver lc1_ocores_i2c_drv = {
	.probe   = ocores_i2c_probe,
	.remove  = ocores_i2c_remove,
	.driver  = {
			.name = "ocores-i2c-cls0",
			.of_match_table = ocores_i2c_match,
			.pm = OCORES_I2C_PM,
	},
};

static struct platform_driver lc2_ocores_i2c_drv = {
	.probe   = ocores_i2c_probe,
	.remove  = ocores_i2c_remove,
	.driver  = {
			.name = "ocores-i2c-cls1",
			.of_match_table = ocores_i2c_match,
			.pm = OCORES_I2C_PM,
	},
};
...
{
	int rc = 0;
	rc = platform_driver_register(&lc1_ocores_i2c_drv);
	rc |= platform_driver_register(&lc2_ocores_i2c_drv);
	return rc; 
}

static void __exit drv_exit(void)
{
    platform_driver_unregister(&lc1_ocores_i2c_drv);
	platform_driver_unregister(&lc2_ocores_i2c_drv);
}
...
MODULE_DESCRIPTION("Cls OpenCores I2C bus driver");
MODULE_LICENSE("GPL");
MODULE_ALIAS("platform:ocores-i2c-cls");
