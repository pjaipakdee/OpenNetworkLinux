/*
 * baseboard_cpld.c - The CPLD driver for the Base Board of Ivystone
 * The driver implement sysfs to access CPLD register on the baseboard of Ivystone via LPC bus.
...
#define DRIVER_NAME "ivystone.cpldb"
/**
...
MODULE_DESCRIPTION("Celestica Ivystone CPLD baseboard driver");
